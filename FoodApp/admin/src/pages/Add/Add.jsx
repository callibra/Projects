...
//   return (
//     <div className='add' style={{ pointerEvents: 'none' }}>
...
//           <div className="add-category flex-col">
//             <p>Product category</p>
//             <select name="category" value={data.category} onChange={onChangeHandler} disabled>
//               <option value="Salad">Salad</option>
//               <option value="Rolls">Rolls</option>
//               <option value="Deserts">Deserts</option>
//               <option value="Sandwich">Sandwich</option>
...
//           </div>
//         </div>
//         <button type='button' className='add-btn' disabled>ADD</button>
//       </form>
//       <Footer />
//     </div>
//   );
